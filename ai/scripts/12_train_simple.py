...
IMG_SIZE, BATCH, EPOCHS = 32, 16, 150
...
print('=== Simple Training (no aug, low reg) ===')
...
callbacks = [
    ...
    keras.callbacks.EarlyStopping(monitor='val_accuracy', patience=40, restore_best_weights=True, verbose=1),
]
